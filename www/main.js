...
let SideMenuComponent = class SideMenuComponent {
    ...
    onMenuItemClick(itemName) {
        ...
        const urlSegment = itemName === 'dashboard' ? src_environments_environment__WEBPACK_IMPORTED_MODULE_2__.environment.userType : itemName;
